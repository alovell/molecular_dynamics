...
\noindent The last term in this equation can be calculated since for $R>R_c$, $g(R) = 1$. For the mentioned values of $\epsilon$ and $\sigma$ in the Lennard Jones potential, the value is $
