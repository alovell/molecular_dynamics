%Changed 'the lattice structure' to 'the most stable and standard lattice structure' at the beginning of crystalline array since theoretically hcp structures can be achieved
%Changed a sentence in Verlet to roll better
%Change face-central cubic in 3.1 to face-centered cubic
%Removed a sentence at the end of the conclusion which stated our simulation was good enough, found this odd and unnecessary
%Removed a comma after 'because' in the third paragraph of energy conservation since it broke the sentence overly.
