...
\end{tabular}
\label{temptable}
\caption{Calculated temperatures, $T$, and their uncertainties $\sigma$, given as $T \pm \sigma$, used throughout the remainder of the calculations.  $SE_T$ gives the difference between the calculated temperature ($T$) and the target temperature.}
\end{center}
\end{table*}
